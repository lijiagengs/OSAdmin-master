	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="" enctype="multipart/form-data">
				<label>标题</label>
				<input type="text" name="title" value="<{$_POST.title}>" class="input-xlarge" required="true" autofocus="true" >
				<label>描述</label>
				<textarea name="name" rows="3" class="input-xlarge" required="true" autofocus="true"><{$_POST.name}></textarea>                               
                                <label>图片上传</label>
