...
class Medicalnews extends XhdoctorBase
{
//class Sample extends Base {
	...
	public static function getMedicalnews($start ='' ,$page_size='') {
                $limit ="";
		if($page_size){
	...
	public static function delMedicalnews ( $id ){
		if (! $id || ! is_numeric ( $id )) {
			return false;
		}
		$db=self::__instance();
	...
	public static function addMedicalnews($group_data) {
	...
	public static function getMedicalnewsById($id) {
		if (! id || ! is_numeric ( $id )) {
			return false;
		}
		$db=self::__instance();
	...
	public static function updateMedicalnews($id,$update_data) {
